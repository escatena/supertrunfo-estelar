...
pl1.sock.emit('jogando', pl1.nome, pl2.nome);
pl2.sock.emit('jogando', pl2.nome, pl1.nome);

pl1.sock.join(pl1.name);
pl2.sock.join(pl1.name);
...
//Inicia o jogo
 ...
 var jogo = new Supertrunfo(pl1,pl2);
delete jogo;
})
